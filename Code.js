class Code{
	constructor(){
		this.char = [['Q','img/Q.png'],['M','img/M.png'],['H','img/H.png'],['L','img/L.png'],['X','img/X.png'],['T','img/T.png'],['W','img/W.png'],['Z','img/Z.png'],['S','img/S.png'],['V','img/V.png'],['N','img/N.png'],['O','img/O.png'],['A','img/A.png'],['C','img/C.png']];
		this.length = 3;
		this.cur = [];
		//下落速度
		this.speed = 5;
	...
	getChar(){
		...
		divs.style.cssText = `width:50px;height:50px;color:#fff;
